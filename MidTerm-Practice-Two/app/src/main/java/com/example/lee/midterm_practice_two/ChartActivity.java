...
public class ChartActivity extends AppCompatActivity {
    ...
    private Paint paint; // painting features - color, thickness, style
    private Bitmap bitmap; //content for drawing
    private Canvas canvas; //  contains the drwaing methods
    //
    int barStartY = 0; // starting Y coordinate
    int barY = 0; // the bar - Y axis
    int barHeight = 100;

    //array holds the state of checkboxes
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //get state of check boxes from intent object
        // using Extras
        ...
        //create image view object from resources
        ...
        //copy and paste for LAB EXAM - canvas & bitmap is needed to draw (its set up here)
